...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/b24_dinov3_iml_ccm_video_paperloss_lora32.yml")
    ...
    out = model(x, ablation={"disable_ccm": args.disable_ccm})
